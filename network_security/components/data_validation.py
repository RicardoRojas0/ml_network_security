...
class DataValidation:
    ...
    def detect_data_drift(self, base_df, current_df, threshold=0.05) -> bool:
        try:
            ...
            # Getting the file path for the drift report
            drift_report_file_path = self.data_validation_config.drift_report_file_path

            # Create a directory for the drift report
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        Returns:
            DataValidationArtifact: The data validation artifact.
        """
        try:
            ...
            if not status:
                error_message = "Test dataframe doest not contain all columns"
            ...
            # Save training dataframe in valid train file path
